...
// FileStorage is a file storage for a token
...
// NewFileStorage creates a new file storage for a token
...
// Save writes a token into a file
...
// Load read a token from the file
