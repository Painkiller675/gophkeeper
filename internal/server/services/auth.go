...
import (
	...
	"github.com/Painkiller675/gophkeeper/pkg/hasher/hmac"
	"github.com/Painkiller675/gophkeeper/pkg/token"
	"github.com/Painkiller675/gophkeeper/pkg/token/jwt"
)

// AuthService is an implementation of proto.AuthServiceServer interface
...
// NewAuthService creates a new service  AuthService
...
// RegisterService registers service AuthService on a gRPC server
func (srv *AuthService) RegisterService(s grpc.ServiceRegistrar) {
	pb.RegisterAuthServiceServer(s, srv)
}

// SignUp the function of registration
...
// SignIn the function of authentication
...
// VerifyToken the function of token validation
